...
linhas = pegar_linhas_da_view_do_banco('visao_mobiliario')
separar_linhas_categoria_mobiliario = separar_o_retorno_por_variavel(linhas)

class mobiliario_view:
    def __init__(self):
        pass

    def main(self, page: ft.Page):
        page.title = "Mobiliário"
        ...
        snack_bar = ft.SnackBar(
                content=ft.Text("Use o filtro para consultar a disponibilidade dos itens de mobiliário."),
                action="OK",
        ...
        for p in separar_linhas_categoria_mobiliario:
