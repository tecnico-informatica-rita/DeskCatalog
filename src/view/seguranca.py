...
linhas = pegar_linhas_da_view_do_banco('visao_segurança')
separar_linhas_categoria_seguranca = separar_o_retorno_por_variavel(linhas)
...
class seguranca_view:
    ...
    def main(self, page: ft.Page):
        ...
        snack_bar = ft.SnackBar(
                content=ft.Text("Use o filtro para verificar a disponibilidade dos itens de segurança."),
                action="OK",
        ...
        for p in separar_linhas_categoria_seguranca:
