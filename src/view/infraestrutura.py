...
separar_linhas_categoria_infraestrutura = separar_o_retorno_por_variavel(linhas)
...
class infraestrutura_view:
    ...
    def main(self, page: ft.Page):
        ...
        snack_bar = ft.SnackBar(
                content=ft.Text("Use o filtro para verificar a disponibilidade dos itens de infraestrutura."),
                action="OK",
        ...
        for p in separar_linhas_categoria_infraestrutura:
