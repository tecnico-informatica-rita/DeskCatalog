...
linhas = pegar_linhas_da_view_do_banco('visao_salas_laboratorios')
separar_linhas_categoria_salas = separar_o_retorno_por_variavel(linhas)
...
class sala_view:
    ...
    def main(self, page: ft.Page):
        ...
        for p in separar_linhas_categoria_salas:
