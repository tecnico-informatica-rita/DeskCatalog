...
import flet as ft
from model.model_deskcatalog import (
    separar_o_retorno_por_variavel,
    pegar_linhas_da_view_do_banco
)
...
def main(page: ft.Page, conn):
    ...
    linhas = pegar_linhas_da_view_do_banco(conn, "visao_informatica")
    informatica = separar_o_retorno_por_variavel(linhas)
